...
export function generatePageMetadata({
    ...
    return {
        ...
        alternates: {
            canonical: canonical || `https://regal-traders.vercel.app${canonical}`,
        },
        openGraph: {
            title,
            description,
            url: canonical || 'https://regal-traders.vercel.app',
            images: [
                {
                    url: ogImage,
                    width: 1200,
...
export function getOrganizationSchema() {
    return {
        ...
        image: 'https://regal-traders.vercel.app/og-image.jpg',
        address: {
            '@type': 'PostalAddress',
...
export function getLocalBusinessSchema() {
    return {
        ...
        name: 'Regal Traders',
        image: 'https://regal-traders.vercel.app/og-image.jpg',
        '@id': 'https://regal-traders.vercel.app',
        url: 'https://regal-traders.vercel.app',
        telephone: '+91-XXXXXXXXXX',
        priceRange: '$$',
        address: {
